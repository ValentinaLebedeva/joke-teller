...
// VoiceRSS Javascript SDK by zero to mastery
...
// text of the joke
function toggleJokeText(joke) {
    jokeText.textContent = `${joke}`;
    jokeText.hidden = !jokeText.hidden;
}
...
function tellMe(joke) {
    // API from voice RSS
    VoiceRSS.speech({
        key: '8ae52c21318b48f7883699f89f8b02e2',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0,
...
button.addEventListener("touch", getJokes);

audioElement.addEventListener("ended", toggleButton);
audioElement.addEventListener("ended", toggleJokeText);